...
RUN set -x \ 
        ...
        && { \
        echo '#!/bin/sh'; \
        echo 'cd /home/HoshinoBot/HoshinoBot/ && python3 -m pip install -r /home/HoshinoBot/HoshinoBot/requirements.txt && pip install -r /home/HoshinoBot/HoshinoBot/hoshino/modules/yobot/src/client/requirements.txt  -i https://pypi.tuna.tsinghua.edu.cn/simple && python3.8 /home/HoshinoBot/HoshinoBot/run.py'; \
